    ...
    Scaffold(
            bottomBar = {
                if (showBottomBar) {
                    TapSenseBottomBar(
                            ...
                            onHomeClick = {
                                navController.navigateTopLevel(TapSenseDestinations.HOME)
                            },
                            onMyPhoneClick = {
                                navController.navigateTopLevel(TapSenseDestinations.MY_PHONE)
                            },
                            onTapGuideClick = {
                                navController.navigate(TapSenseDestinations.TAP_GUIDE)
                            },
                            onSettingsClick = {
                                navController.navigateTopLevel(TapSenseDestinations.SETTINGS)
                            },
                    )
                }
            },
        ...
        NavHost(
            ...
            composable(TapSenseDestinations.MY_PHONE) {
                MyPhoneRoute(
                        onTestLocation = { navController.navigate(TapSenseDestinations.TAP_TEST) }
                )
            }
